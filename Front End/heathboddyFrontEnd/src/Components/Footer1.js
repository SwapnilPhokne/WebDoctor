            ...
            <div class="footer">
                <div class="inner-footer">
                    ...
                    <div class="footer-items">
                        ...
                        <div class="border1"></div>
                        <ul>
                            <li><i class="fa fa-map-marker" aria-hidden="true"></i>Swapnil Vinayak Phokne</li>
                            <li><i class="fa fa-phone" aria-hidden="true"></i>8329903294</li>
                            <li><i class="fa fa-envelope" aria-hidden="true"></i>phokneswapnil@gmail.com</li>
                        </ul>
